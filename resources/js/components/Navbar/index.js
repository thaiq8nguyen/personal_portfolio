...
import {AppBar, Button, Container, Divider, Drawer, IconButton, List, ListItem, ListItemText, Toolbar, Typography } from "@material-ui/core"
...
const NavBar = () => {
        ...
        <div style={{minHeight: "100vh"}} className = {classes.list}>
            ...
            <Container className={classes.briefIntroContainer}>
                <Typography variant="body2">
                    <strong>Thai Nguyen</strong> is a web developer, tinkerer, and traveler.
                </Typography>
                <br/>
                <Typography variant="body2">
    ...
    return (
        <div className={classes.root}>
            ...
            <Drawer open={sideMenu} ModalProps={{onBackdropClick: handleToggleSideMenu}} >
                {sideMenuContent()}
            </Drawer>
